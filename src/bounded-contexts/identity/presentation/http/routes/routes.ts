...
export function IdentityRoutes() {
        ...
        identityRouter.post(
                ...
                protectHandler(async (req, res) => {
                        ...
                        const response = await usecase.logout.execute(refreshToken);
        ...
        identityRouter.post('/auth/refresh', protectHandler(async (req, res) => {
                const refreshToken = req.cookies.refreshToken;

                const response = await usecase.tokenRefresh.execute(refreshToken);
